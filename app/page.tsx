...
import AlertLoadingSkeleton from "../components/tableLoadingSkeleton";

const SensorChart = lazy(() => import("../components/sensorChart"));
const SensorGauge = lazy(() => import("../components/sensorGauge"));
  ...
  return (
    <>
      <div className="min-h-screen bg-[#2E2A3B] text-white">
        ...
        <div className="p-4">
          <Suspense fallback={<AlertLoadingSkeleton />}>
              ...
              {groupedData[selectedDevice].map((sensor) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <Suspense fallback={<LoadingSpinner message="Loading data..." size="large" />}>
